...
// Returns the private 'App\Repository\CreaturesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CreaturesRepository.php';

return $this->privates['App\Repository\CreaturesRepository'] = new \App\Repository\CreaturesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
