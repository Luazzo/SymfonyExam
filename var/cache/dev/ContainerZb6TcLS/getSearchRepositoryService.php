...
// Returns the private 'App\Repository\SearchRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SearchRepository.php';

return $this->privates['App\Repository\SearchRepository'] = new \App\Repository\SearchRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
